...
namespace B2ProfileGUI
{
	public partial class MainForm : Form
	{
		...
		public void MainForm_IncreaseNextBonusStat()
		{
			MainForm_TransferToProfile();

			Program.Profile.IncreaseNextBonusStat();

			MainForm_TransferFromProfile();
		}

		public void MainForm_DecreaseNextBonusStat()
		{
			MainForm_TransferToProfile();

			Program.Profile.DecreaseNextBonusStat();
